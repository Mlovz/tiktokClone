  ...
  return (
    <ul className="header__menu">
      <li className="header__menu__item">
        <Link
          to="/upload"
          className={`header__menu__link ${pathname === "/upload" && "active"}`}
        >
          <svg
            width="32"
            height="32"
        ...
        <div className="header__menu__link">
          <div className="btn-group">
            ...
            className="dropdown-menu dropdown-menu-end">
              ...
              <li>
                <div onClick={handleLogout} style={{borderTop: '1px solid #dbdbdb'}} className="dropdown-item">
